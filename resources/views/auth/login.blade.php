                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Social APP</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form method="post" class="theme-form" action="{{ route('admin.login') }}" aria-label="{{ __('Login') }}">
                                        @csrf
                                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Ahjili </p>
                        </div>
                    </div>
                </div>
            </div>
