@extends('layouts.master')
        ...
        @section('content')
            @component('components.breadcrumb')
                ...
                @slot('title') All Post Likes @endslot
            @endcomponent
                <!-- end row -->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Like by user</h4>
                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted">All Likes in the application</p>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center pagi-list">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="fs-13 mb-1">Like By :  <a href="#" class="link text-dark">{{$like['username']}}</a></h5>
                                            <p class="born timestamp text-muted mb-0">{{$like['post_body']}}</p>
                                        </div>
