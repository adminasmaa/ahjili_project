                        ...
                        <table class="table align-middle table-nowrap hover" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.posts.show',['id' =>$singldata->post_id ])}}">{{short_string($singldata->post->title) ?? ""}}</a></td>
                                    <td>{{ucfirst($singldata->post->post_type) ?? ""}}</td>
                                    <td>{{short_string($singldata->reason)}}...</td>
                                    <td>{{count($singldata->post->reportAbusePost) ?? 0}}</td>
                                    <td>{{$singldata->user->username  ?? ''}}</td>
