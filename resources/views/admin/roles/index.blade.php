                                ...
                                @foreach($roles as $role)
                                    <tr>
                                        <td class="id" style="display:none;"><a href="javascript:void(0);"
                                                                                class="fw-medium link-primary ">{{$role->id}}</a>
                                        </td>
                                        <td class="customer_name td-padding">{{$role->name}}</td>

                                        <td class="date">{{ globaldate($role->created_at) }}</td>
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="remove" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    ...
                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                            ...
                                                            data-bs-target="#deleteRecordModal_{{$role->id}}"><i
                                                            class="mdi mdi-delete"></i></button>
                                                </div>

                                                <!-- Modal -->
                                                <div class="modal fade zoomIn" id="deleteRecordModal_{{$role->id}}"
