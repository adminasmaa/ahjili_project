    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <label class="mt-2">Current Login IP : {{Auth::user()->last_login_ip}}</label>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img src="{{ URL::asset('/assets/images/flags/Iraq.png') }}" class="rounded" alt="Header Language"
                                height="20">
            ...
            {{--   <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="{{ url('index/iq') }}" class="dropdown-item notify-item language" data-lang="sp"
                            title="Iraq">
                            <img src="{{ URL::asset('assets/images/flags/iraq.png') }}" alt="user-image" class="me-2 rounded" height="20">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != ''){{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('assets/images/users/avatar-1.jpg') }}@endif"
                                alt="Header Avatar" onerror="{{ URL::asset('assets/images/users/avatar-1.jpg') }}">
