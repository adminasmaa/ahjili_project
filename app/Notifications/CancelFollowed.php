...
class CancelFollowed extends Notification implements ShouldQueue
{
    use Queueable;
    public $user;
    public $fcmtoken;
    ...
    {
        return [
            'title' => "Follow-up canceled by {$this->user->username}",
    ...
    public function toFirebase($notifiable)
    {
        return (new FirebaseMessage())
            ->withTitle("Follow-up canceled by {$this->user->username}")
            ->withSound('default')
            ->withPriority('high')
