...
class ChatifyMessenger
{
    ...
    public function __construct()
    {
        $this->pusher = new Pusher(
            "298b6a2d6dd1c5a67d92", //key
            "716bd03068d448c96d2e", //secret
            "1469564",
            array('cluster' => 'ap2')
        );
    }
    ...
    public function fetchMessage($id, $index = null)
    {
        ...
        return [
            ...
            'to_id' => $msg->to_id,
            'message' => $msg->body,
            'attachment' => array('attachment' =>$attachment,'title' => $attachment_title, 'type' => $attachment_type),
    ...
    public function messageCard($data, $viewType = null)
    {
        ...
        return view('vendor.Chatify.layouts.messageCard', $data)->render();
    }
